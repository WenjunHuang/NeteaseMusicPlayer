...
from MusicPlayer.view_models.personalized_newsong_view_model import PersonalizedNewSongViewModel
...
def register_qml_types():
    ...
    qmlRegisterType(PersonalizedNewSongViewModel, "MusicPlayer", 1, 0, PersonalizedNewSongViewModel.__name__)
