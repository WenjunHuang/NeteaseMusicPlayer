    ...
    DatabaseResponseHandler<QVector<TPlayListSong>>* DatabaseRepository::getAllPlayListSongs() {
        ...
        QCoreApplication::postEvent(this, new DatabaseActionEvent{[this,response]() {
                                        try {
                                            ...
                                            emit response->finished(QString(error.what()));
                                        }
...
//        });
    ...
    DatabaseResponseHandler<std::optional<TImageCache>>* DatabaseRepository::getImageCacheByUrl(QString url) { return nullptr; }
